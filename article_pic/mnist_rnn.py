...
mnist = input_data.read_data_sets('/home/liushuai/TensorFlow_Notebook/MNIST_data',one_hot = True)
time_steps = 28
num_units = 128
n_input = 28
learning_rate = 0.001
...
outputs,_ = tf.contrib.rnn.static_rnn(lstm_layer,inputs,dtype='float32')
